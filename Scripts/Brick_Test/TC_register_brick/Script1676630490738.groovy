...
WebUI.setText(findTestObject('Brick_Test_Register/input_email'), 'yuliantisa@gmail.comn')
...
WebUI.verifyElementPresent(findTestObject('Brick_Test_Register/div_success_register'), 0)
